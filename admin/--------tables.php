                    ...
                    <div class="has-pagination" style="margin:auto;">
                        <div class="table-wrapper has-mobile-cards p-5">
                            ...
                            <form style="display:flex;" class="mb-5  mt-5" action="#">
                                <div style="width:50%;">
                                    <p>วันที่เริ่มต้น</p>
                                    <input  name="dateStart" class="input" type="date" placeholder="dateStart">
                                </div>
                                <div style="width:50%;">
                                    <p>วันที่สิ้นสุด</p>
                                    <input  name="dateEnd" class="input" type="date" placeholder="dateStart">
                                </div>
        ...
        <div class="card-content">
            <div class="b-table has-pagination" style="padding:2%;">
                ...
                <form style="display:flex;" class="mb-5  mt-5" action="#">
                    <div style="width:50%;">
                        <p>วันที่เริ่มต้น</p>
                        <input  name="dateStart2" class="input" type="date"
                        placeholder="dateStart">
                    </div>
                    <div style="width:50%;">
                        <p>วันที่สิ้นสุด</p>
                        <input  name="dateEnd2" class="input" type="date"
                        placeholder="dateStart">
                    </div>
                    <input type="text" hidden value="true" name="datefilter">
