...
$query1 = "SELECT * FROM `report_activities`   ORDER BY `id` DESC"; 
    //3.เก็บข้อมูลที่ query ออกมาไว้ในตัวแปร result . 

$result1 = new db($query1); 

?>
<div align="center">
    <div  class="alert alert-info">
        <h1 style="font-size:25px;"><font color="#000">ตารางแสดงกิจกรรมทั้งหมด</font></h1> 
    </div>
</div>
...
<td>
    <center>
        <?php echo $row1['descript'];?>
    </center>

</td>
<td>
 <center>
    <?php echo $row1['name_control'];?>
</center>
</td>
